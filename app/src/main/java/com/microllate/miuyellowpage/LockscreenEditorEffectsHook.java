 ...
 *
 * Keep the compatibility change local to MIUIAod. The system wallpaper
 * service is not modified; users should disable lockscreen carousel when
 * using wallpaper effects.
 */
public final class LockscreenEditorEffectsHook implements IXposedHookLoadPackage {
    ...
    public void handleLoadPackage(XC_LoadPackage.LoadPackageParam lpparam) {
        ...
        try {
            ...
            log("installed: editor compatibility enabled");
        } catch (Throwable e) {
